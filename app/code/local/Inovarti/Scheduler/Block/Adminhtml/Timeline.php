 ...
 */
class Inovarti_Scheduler_Block_Adminhtml_Timeline extends Mage_Adminhtml_Block_Widget_Container {
	...
	protected function _construct() {
		$this->_headerText = Mage::helper('inovarti_scheduler')->__('Scheduler Timeline');
		$this->loadSchedules();
		parent::_construct();
	}
	...
	protected function loadSchedules() {
		...
		foreach ($collection as $schedule) { /* @var $schedule Inovarti_Scheduler_Model_Schedule */
	 ...
	 * @return string
	 */
	public function getGanttDivAttributes(Inovarti_Scheduler_Model_Schedule $schedule) {
