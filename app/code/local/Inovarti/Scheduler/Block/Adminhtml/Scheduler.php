 ...
 */
class Inovarti_Scheduler_Block_Adminhtml_Scheduler extends Mage_Adminhtml_Block_Widget_Grid_Container {
	...
	public function __construct() {
		...
		$this->_headerText = Mage::helper('inovarti_scheduler')->__('Scheduled tasks');
		parent::__construct();
	}
