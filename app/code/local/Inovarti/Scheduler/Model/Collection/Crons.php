 ...
 */
class Inovarti_Scheduler_Model_Collection_Crons extends Varien_Data_Collection {
	 ...
	 * @param bool $logQuery
	 * @return Inovarti_Scheduler_Model_Collection_Crons
	 */
	public function loadData($printQuery = false, $logQuery = false) {
		...
		foreach ($this->getAllCodes() as $code) {
			$configuration = Mage::getModel('inovarti_scheduler/configuration')->loadByCode($code);
