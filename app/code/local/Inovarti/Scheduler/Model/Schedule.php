 ...
 */
class Inovarti_Scheduler_Model_Schedule extends Mage_Cron_Model_Schedule {

	/**
	 * @var Inovarti_Scheduler_Model_Configuration
	 */
	 ...
	 * @return Inovarti_Scheduler_Model_Schedule
	 */
	 ...
	 *
	 * @deprecated use Inovarti_Scheduler_Model_Schedule::schedule() instead
	 * @return Inovarti_Scheduler_Model_Schedule
	 */
	 ...
	 *
	 * @return Inovarti_Scheduler_Model_Configuration
	 */
	public function getJobConfiguration() {
		if (is_null($this->_jobConfiguration)) {
			$this->_jobConfiguration = Mage::getModel('inovarti_scheduler/configuration')->loadByCode($this->getJobCode());
		}
