 ...
 */
class Inovarti_Scheduler_Model_Observer extends Mage_Cron_Model_Observer {
	...
	public function dispatch($observer)
	{
		...
		foreach ($schedules->getIterator() as $schedule) { /* @var $schedule Inovarti_Scheduler_Model_Schedule */
			try {
	 ...
	 * @param $error
	 * @return Inovarti_Scheduler_Model_Observer
	 */
	protected function sendErrorMail(Inovarti_Scheduler_Model_Schedule $schedule, $error) {
