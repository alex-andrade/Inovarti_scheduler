 ...
 */
class Inovarti_Scheduler_Adminhtml_CronController extends Inovarti_Scheduler_Adminhtml_AbstractController {
	...
	public function disableAction() {
		...
		$disabledCrons = Mage::helper('inovarti_scheduler')->trimExplode(',', Mage::getStoreConfig('system/cron/disabled_crons'), true);
	...
	public function scheduleNowAction() {
		...
		if (is_array($codes)) {
			foreach ($codes as $key) {
				Mage::getModel('cron/schedule') /* @var Inovarti_Scheduler_Model_Schedule */
					->setJobCode($key)
					->schedule()
					->save();
